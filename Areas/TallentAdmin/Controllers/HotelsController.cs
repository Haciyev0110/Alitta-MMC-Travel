...
namespace AllittaMMC.Areas.TallentAdmin.Controllers
{
    public class HotelsController : Controller
    {
        ...
        // GET: TallentAdmin/Hotels
        public ActionResult Index()
        {
            return View(db.Hotels.ToList());
        }

        // GET: TallentAdmin/Hotels/Details/5
        ...
        // GET: TallentAdmin/Hotels/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: TallentAdmin/Hotels/Create
        ...
        // GET: TallentAdmin/Hotels/Edit/5
        ...
        // POST: TallentAdmin/Hotels/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: TallentAdmin/Hotels/Delete/5
        ...
        // POST: TallentAdmin/Hotels/Delete/5
